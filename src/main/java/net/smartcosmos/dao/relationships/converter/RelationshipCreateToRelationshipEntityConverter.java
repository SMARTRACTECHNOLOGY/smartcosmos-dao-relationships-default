...
public class RelationshipCreateToRelationshipEntityConverter
    ...
    public RelationshipEntity convert(RelationshipCreate createRelationship) {
        ...
        return RelationshipEntity.builder()
            .sourceType(createRelationship.getSource()
                            .getType())
            .sourceId(UuidUtil.getUuidFromUrn(createRelationship.getSource()
                                                  .getUrn()))
            .relationshipType(createRelationship.getRelationshipType())
            .targetType(createRelationship.getTarget()
                            .getType())
            .targetId(UuidUtil.getUuidFromUrn(createRelationship.getTarget()
                                                  .getUrn()))
            .build();
    }
